        ...
        >
            ...
            <template slot="items" slot-scope="props">
                <tr v-bind:class="{'active': props.index%2==1}" style="cursor: pointer;">
                    ...
                    <td class="text-xs-center px-2 py-2" style="width:120px;height:36px;border-right: 1px solid #dedede">
                        <content-placeholders v-if="loadingTable">
                            <content-placeholders-text :lines="1" />
                        </content-placeholders>
                        <div v-else>
                            <v-tooltip top class="mx-2">
                                <v-btn @click="editServiceinfo(props.item)" color="blue" slot="activator" flat icon class="mx-0 my-0">
                                    <v-icon>edit</v-icon>
                                </v-btn>
                                <span>Sửa</span>
                            </v-tooltip>
                            <v-tooltip top class="mx-2">
                                <v-btn @click="deleteServiceinfo(props.item)" color="red" slot="activator" flat icon class="mx-0 my-0">
...
export default {
  ...
  methods: {
    ...
    editServiceinfo (item) {
      ...
      let newQuery = current.query
      vm.$router.push({
        path: '/table/opencps_serviceinfo/editor/' + item.serviceInfoId,
        query: newQuery
      })
    },
