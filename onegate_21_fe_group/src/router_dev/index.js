...
const routes = [
  { path: '/:groupId/danh-sach-ho-so/:index', name: 'Landing', component: Landing, props: true },
  { path: '/m/:groupId/danh-sach-ho-so/:index', name: 'LandingMobile', component: LandingMobile, props: true },
  { path: '/:groupId/danh-sach-ho-so/:index/tiep-nhan-ho-so/:id/:formCode', name: 'TiepNhanHoSoDetail', component: TiepNhanHoSoDetail, props: true },
  { path: '/:groupId/danh-sach-ho-so/:index/nhom-ho-so/:id', name: 'TiepNhanNhomHoSo', component: TiepNhanNhomHoSo, props: true },
  { path: '/:groupId/danh-sach-ho-so/:index/chi-tiet-ho-so/:id', name: 'XemChiTietHoSoDetailCanBo', component: XemChiTietHoSoDetailCanBo, props: true },
  { path: '/:groupId/danh-sach-ho-so/:index/xu-ly-ho-so', name: 'XuLyHoSo', component: XuLyHoSo, props: true },
  { path: '/:groupId/danh-sach-ho-so/:index/bo-sung-ho-so/:id', name: 'HoanThienBoSungHoSoDetail', component: HoanThienBoSungHoSoDetail, props: true },
  { path: '/:groupId/danh-sach-ho-so/:index/ho-so/:id/:formCode', name: 'DetailForward', component: DetailForward, props: true },
