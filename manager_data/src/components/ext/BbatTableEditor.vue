<template>
  <div>
    <v-card class="px-0 mx-0" style="overflow: hidden;">
      <v-toolbar color="blue darken-3 tool-bar-01 pl-2" dark height="42">
      ...
      <div class="grid-list mt-2 mx-2" v-if="showDetailForm">
