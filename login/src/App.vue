<template>
  <v-app id="app_login">
    <div @click="showNoti" v-if="drawer" style="position: fixed;width: 100%;height: 100vh;left: 0;top: 0;"></div>
    ...
    <div v-else>
      ...
      <v-navigation-drawer v-model="drawer" temporary fixed clipped right hide-overlay>
        <v-list class="pa-1">
          <v-list-tile>
            <v-list-tile-content>
