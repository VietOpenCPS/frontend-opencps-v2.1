          ...
          <div class="adv_search px-2 my-2 mx-2" style="background: #eeeeee">
            <div class="searchAdvanced-content pb-2">
              <v-layout wrap>
                ...
                <v-flex xs6 class="px-2" v-if="capCoQuanThucHien === 'XA_PHUONG'">
                  <div>
                ...
                <v-flex :class="capCoQuanThucHien === 'XA_PHUONG' ? 'mb-2 px-2 xs12 sm6' : 'mb-2 px-2 xs12'">
                  <div>
                  ...
                  vm.$store.dispatch('getServiceInfo', {
                    ...
                    if (!vm.isOffLine) {
                      vm.$store.dispatch('postDossier', data).then(function (result) {
                        ...
                        vm.indexAction = -1
                        vm.$router.push({
                          path: vm.pathLanding + 0 + '/ho-so/' + result.dossierId + '/NEW',
        ...
        if (vm.serviceConfigSelect.serviceUrl) {
          ...
          vm.$store.dispatch('postDossier', data).then(function (result) {
            if (result['status'] !== undefined && result['status'] === 203) {
              ...
              vm.indexAction = -1
              vm.$router.push({
                path: vm.pathLanding + 0 + '/ho-so/' + result.data.dossierId + '/NEW',
                query: vm.$router.history.current.query
              })
            }
