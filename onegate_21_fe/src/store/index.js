...
export const store = new Vuex.Store({
  ...
  actions: {
    ...
    copyFileFromStorage ({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        let param = {
          headers: {
            groupId: state.initData.groupId
        ...
        let dataPost = new URLSearchParams()
        dataPost.append('dossierTemplateNo', filter.dossierTemplateNo ? filter.dossierTemplateNo : '')
        dataPost.append('dossierPartNo', filter.partNo ? filter.partNo : '')
    ...
    getApplicantDocumentProxy ({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          let param = {
            headers: {
    ...
    getFileItemsProxy ({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        store.dispatch('loadInitResource').then(function (result) {
          let param = {
            headers: {
    ...
    insertSignatureVtCa ({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        ...
        let dataPost = new URLSearchParams()
        dataPost.append('fileName', filter.fileName)
        dataPost.append('fileEntryId', filter.fileEntryId)
    ...
    uploadSignatureVtCa ({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        let param = {
          headers: {
            groupId: state.groupIdSite ? state.groupIdSite : window.themeDisplay.getScopeGroupId(),
        ...
        let dataPost = new URLSearchParams()
        dataPost.append('uploadfile', filter.signedFileName)
        let url = '/o/rest/v2/defaultsignature/vtca/fileupload'
        axios.post(url, dataPost, param).then(function (response) {
          let serializable = response.data
          resolve(serializable)
        }).catch(function (error) {
    ...
    signatureVtSimCa ({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        let param = {
          headers: {
        ...
        let dataPost = new URLSearchParams()
        let url = '/o/rest/v2/signature/' + filter.dossierId + '/signSimCA/' + filter.referenceUid + '/' + filter.mobile
        axios.post(url, dataPost, param).then(function (response) {
          let serializable = response.data
          resolve(serializable)
        }).catch(function (error) {
    ...
    searchLgspDoanhNghiepVer2({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        let config = {
          headers: {
    ...
    getStatusAccount ({commit, state}, filter) {
      return new Promise((resolve, reject) => {
        let param = {
          headers: {
            groupId: window.themeDisplay ? window.themeDisplay.getScopeGroupId() : '',
