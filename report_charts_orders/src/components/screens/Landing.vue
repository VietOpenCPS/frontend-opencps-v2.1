<template>
  <div class="form-chitiet">
        ...
        <div class="flex xs12 pl-3 text-ellipsis text-bold">
          <v-layout wrap class="chart__report">
            ...
            <v-flex xs12 sm8 class="px-2 text-right" style="    padding-top: 1px;">
              ...
              <v-btn v-if="modules.indexOf('3') >= 0" icon class="mx-0 my-0" v-on:click.native="$vuetify.goTo('#lineChartID', options)">
    ...
    <v-layout row wrap style="margin: 0" v-if="String(index) === '0'">
      <!-- M1 -->
      <v-flex v-if="modules.indexOf('1') >=0" xs12 
        :order-xs1="modules.indexOf('1') + 1 === 1" 
        :order-xs2="modules.indexOf('1') + 1 === 2"  
        :order-xs3="modules.indexOf('1') + 1 === 3"
      >
      ...
      <!-- M2 -->
      <v-flex v-if="modules.indexOf('2') >=0" xs12 
        :order-xs1="modules.indexOf('2') + 1 === 1" 
        :order-xs2="modules.indexOf('2') + 1 === 2"  
        :order-xs3="modules.indexOf('2') + 1 === 3"
      >
        <v-layout row wrap style="margin: 0">
      ...
      <!-- M3 -->
      <v-flex v-if="modules.indexOf('3') >=0" xs12 
        :order-xs1="modules.indexOf('3') + 1 === 1" 
        :order-xs2="modules.indexOf('3') + 1 === 2"  
        :order-xs3="modules.indexOf('3') + 1 === 3"
      >
        <v-layout row wrap style="margin: 0">
...
export default {
  ...
  methods: {
    toNativeViewType () {
      ...
      vm.$router.push({
        path: '/bao-cao/' + vm.modules + '/' + vm.index,
        query: {
          year: vm.year,
          month: vm.month,
          group: vm.group,
