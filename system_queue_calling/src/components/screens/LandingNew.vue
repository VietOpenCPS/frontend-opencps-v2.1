        ...
        <template slot="items" slot-scope="props">
          <tr v-bind:class="{'active': props.index%2==1}" style="cursor: pointer;">
            ...
            <td class="text-xs-center text-bold py-1" width="350px">
              <v-btn
                :loading="loadingCalling"
                :disabled="loadingCalling || bookingCalling['codeNumber'] === props.item['codeNumber'] || (props.item['state'] != 1 && props.item['state'] != 4) || isCalling"
                :color="bookingCalling['codeNumber'] === props.item['codeNumber'] || (props.item['state'] != 1 && props.item['state'] != 4)  ? 'grey' : 'primary'"
                class="white--text"
              ...
              <v-btn
                :loading="loadingCalling"
                :disabled="loadingCalling || bookingCalling['codeNumber'] === props.item['codeNumber'] || props.item['state'] === 3"
  ...
  methods: {
    ...
    mergeBooking (bookingDossier, bookingEform) {
      ...
      vm.$store.dispatch('getBooking', filter).then(function (resultBooking) {
        ...
        bookingRelease = bookingDossierRealease
        // merge
