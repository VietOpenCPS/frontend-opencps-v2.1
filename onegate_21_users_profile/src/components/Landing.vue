<template>
  ...
  ">
    ...
    <v-flex class="xs12 sm4 px-3">
      <v-card style="border-radius: 4px;-webkit-box-shadow: 0 0 2rem 0 rgba(136,152,170,.15)!important;box-shadow: 0 0 2rem 0 rgba(136,152,170,.15)!important;">
        <v-card-text style="width: 300px;padding: 0;margin: 0 auto;">
          <file-pond
            ref="pond"
            name="file"
            ...
            accepted-file-types="image/jpeg, image/png"
            server='http://localhost:8080/o/gate/services/upload'
            />
        </v-card-text>
...
/*
  ...
  */
  ...
  body .filepond--item,
  body .filepond--image-preview-wrapper,
  body .filepond--image-preview,
  body .filepond--image-preview canvas,
  body .filepond--image-preview > div {
