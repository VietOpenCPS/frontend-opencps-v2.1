...
export default {
  ...
  methods: {
    ...
    getDossierTemplate () {
      ...
      vm.$store.dispatch('getDossierTemplate', data).then(
        res => {
    ...
    getServiceProcesses () {
      ...
      vm.$store.dispatch('getServiceProcesses', data).then(
        res => {
    ...
    updateServiceProcessOption (type) {
      ...
      vm.$store.dispatch('createServiceProcessOption', filter).then(function (result) {
        if (type === 'add') {
