...
const TemplateRendering = () => import('./pagging/template_rendering.vue')
const TinyPagination = () => import('./pagging/hanghai_pagination.vue')
const PhanCong = () => import('./form_xu_ly/PhanCongNguoiThucHien.vue')
const YkienCanBoThucHien = () => import('./form_xu_ly/YkienCanBoThucHien.vue')
const FormBoSungThongTinNgan = () => import('./form_xu_ly/FormBoSungThongTinNgan.vue')
