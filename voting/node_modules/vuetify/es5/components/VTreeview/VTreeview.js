...
/* @vue/component */
    ...
    watch: {
        ...
        active: function active(value) {
            ...
            old.forEach(function (key) {
                return _this2.updateActive(key, false);
            });
        ...
        value: function value(_value) {
            ...
            old.forEach(function (key) {
                return _this3.updateSelected(key, false);
            });
            _value.forEach(function (key) {
                return _this3.updateSelected(key, true);
            });
            this.emitSelected();
        },
        open: function open(value) {
            ...
            old.forEach(function (key) {
                return _this4.updateOpen(key, false);
            });
            value.forEach(function (key) {
                return _this4.updateOpen(key, true);
            });
            this.emitOpen();
        }
    },
    created: function created() {
        ...
        this.value.forEach(function (key) {
            return _this5.updateSelected(key, true);
        });
        this.emitSelected();
        this.active.forEach(function (key) {
            return _this5.updateActive(key, true);
        });
        this.emitActive();
    },
    mounted: function mounted() {
        ...
        if (this.openAll) {
            Object.keys(this.nodes).forEach(function (key) {
                return _this6.updateOpen((0, _helpers.getObjectValueByPath)(_this6.nodes[key].item, _this6.itemKey), true);
            });
        } else {
            this.open.forEach(function (key) {
                return _this6.updateOpen(key, true);
            });
        }
        this.emitOpen();
    },
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                var node = {
                    ...
                    children: children.map(function (c) {
                        return (0, _helpers.getObjectValueByPath)(c, _this7.itemKey);
                    }),
                    item: item
                };
